...
-->
    ...
    <td align='center'>${u.issh} <c:if test="${u.issh=='否'}"> 
      <input name="button" type="button" onclick="javascript:location.href='sh.jsp?id=${u.id}&amp;yuan=${u.issh}&amp;tablename=dingdanxinxi'" value="支付"/> </c:if></td>
