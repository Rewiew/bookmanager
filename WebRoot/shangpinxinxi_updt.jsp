...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<script language="javascript">document.form1.leixing.value='${shangpinxinxi.leixing}';</script>
	<script language="javascript">document.form1.pinpai.value='${shangpinxinxi.pinpai}';</script>
