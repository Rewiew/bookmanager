						...
						<tr align="left" >
							<td colspan="17">
								<form action="shangpinxinxiList.do" name="myform" method="post">
									查询   商品编号：<input name="shangpinbianhao" type="text" id="shangpinbianhao" style='border:solid 1px #000000; color:#666666' size="12" />  商品名称：<input name="shangpinmingcheng" type="text" id="shangpinmingcheng" style='border:solid 1px #000000; color:#666666' size="12" /> 类型：<select name='leixing' id='leixing' style='border:solid 1px #000000; color:#666666;'><option value="">所有</option><option value="智能手机">智能手机</option><option value="拍照手机">拍照手机</option><option value="音乐手机">音乐手机</option><option value="商务手机">商务手机</option></select> 品牌：<select name='pinpai' id='pinpai' style='border:solid 1px #000000; color:#666666;'><option value="">所有</option><option value="OPPO">OPPO</option><option value="华为">华为</option><option value="小米">小米</option><option value="vivo">vivo</option><option value="苹果">苹果</option><option value="三星">三星</option><option value="魅族">魅族</option><option value="诺基亚">诺基亚</option><option value="联想">联想</option></select>
