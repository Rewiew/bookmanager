...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr 1><td width="200">备注：</td><td><input name='beizhu' type='text' id='beizhu' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
						...
						<script language="javascript">document.form1.shangpinbianhao.value='${goumaijilu.shangpinbianhao}';</script>
	<script language="javascript">document.form1.shangpinmingcheng.value='${goumaijilu.shangpinmingcheng}';</script>
	<script language="javascript">document.form1.leixing.value='${goumaijilu.leixing}';</script>
	<script language="javascript">document.form1.pinpai.value='${goumaijilu.pinpai}';</script>
	...
	<script language="javascript">document.form1.yonghuming.value='${goumaijilu.yonghuming}';</script>
