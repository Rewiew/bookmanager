...
-->
  ...
  <br><br>
   ...
   <tr>
     ...
     <td width='11%'>类型：</td><td width='39%'>${goumaijilu.leixing}</td>
     <td width='11%'>&nbsp;</td>
     <td width='39%'>&nbsp;</td>
     </tr><tr>
     <td width='11%'>销量：</td><td width='39%'>${goumaijilu.xiaoliang}</td>
     <td width='11%'>库存：</td><td width='39%'>${goumaijilu.kucun}</td></tr><tr>
     ...
     <td width='11%'>购买人：</td><td width='39%'>${goumaijilu.yonghuming}</td></tr><tr>
