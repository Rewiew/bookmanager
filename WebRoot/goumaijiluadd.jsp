...
<form action="addGoumaijilu.do" name="form1" method="post">
		...
		<tr ><td width="200">类型：</td><td><input name='leixing' type='text' id='leixing' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr><script language="javascript">document.form1.leixing.value='<%=connDbBean.readzd("shangpinxinxi","leixing","id",request.getParameter("id"))%>';document.form1.leixing.setAttribute("readOnly",'true');</script>
		<script language="javascript">document.form1.pinpai.value='<%=connDbBean.readzd("shangpinxinxi","pinpai","id",request.getParameter("id"))%>';document.form1.pinpai.setAttribute("readOnly",'true');</script>
