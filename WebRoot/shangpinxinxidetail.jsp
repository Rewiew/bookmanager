...
<div class="content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
         ...
         <td width='11%' height=44>类型：</td><td width='39%'>${shangpinxinxi.leixing}</td></tr><tr>
         ...
         <td width='11%' height=100  >商品简介：</td><td width='39%' colspan=2 height=100 >${shangpinxinxi.shangpinjianjie}</td></tr><tr>							 
