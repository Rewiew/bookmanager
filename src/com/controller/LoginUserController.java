...
public class LoginUserController {
	@Resource
	private loginUserServer yonghuzhuceService;


   
	@RequestMapping("addYonghuzhuce.do")
	public String addYonghuzhuce(HttpServletRequest request, loginUser loginUser, HttpSession session) throws SQLException{
		Timestamp time=new Timestamp(System.currentTimeMillis());
		
		loginUser.setAddtime(time.toString().substring(0, 19));
		yonghuzhuceService.add(loginUser);
...
//	处理编辑
	...
	public String doUpdateYonghuzhuce(int id, ModelMap map, loginUser loginUser){
		loginUser =yonghuzhuceService.getById(id);
		map.put("loginUser", loginUser);
		return "yonghuzhuce_updt";
	}
	
	@RequestMapping("doUpdateYonghuzhuce2.do")
	public String doUpdateYonghuzhuce2(ModelMap map, loginUser loginUser, HttpServletRequest request){
		loginUser =yonghuzhuceService.getById(Integer.parseInt((String)request.getSession().getAttribute("uid")));
		map.put("loginUser", loginUser);
		return "yonghuzhuce_updt2";
	}
	
@RequestMapping("updateYonghuzhuce2.do")
	public String updateYonghuzhuce2(int id, ModelMap map, loginUser loginUser){
		yonghuzhuceService.update(loginUser);
...
//	后台详细
	...
	public String yonghuzhuceDetail(int id, ModelMap map, loginUser loginUser){
		loginUser =yonghuzhuceService.getById(id);
		map.put("loginUser", loginUser);
...
//	前台详细
	...
	public String yhzcDetail(int id, ModelMap map, loginUser loginUser){
		loginUser =yonghuzhuceService.getById(id);
		map.put("loginUser", loginUser);
...
//	
	...
	public String updateYonghuzhuce(int id, ModelMap map, loginUser loginUser, HttpServletRequest request, HttpSession session){
		yonghuzhuceService.update(loginUser);
...
//	分页查询
	...
	public String yonghuzhuceList(@RequestParam(value="page",required=false)String page,
								  ModelMap map, HttpSession session, loginUser loginUser, String yonghuming, String mima, String xingming, String xingbie, String chushengnianyue1, String chushengnianyue2, String QQ, String youxiang, String shouji, String shenfenzheng, String touxiang, String dizhi, String beizhu, String issh){
		...
		List<loginUser> list=yonghuzhuceService.getByPage(pmap);
	...
	public void quchongYonghuzhuce(loginUser loginUser, HttpServletResponse response){
		   Map<String,Object> map=new HashMap<String,Object>();
		   map.put("yonghuming", loginUser.getYonghuming());
		   System.out.println("yonghuming==="+ loginUser.getYonghuming());
