...
//	
   ...
   public String showXinwentongzhi(int id,ModelMap map,HttpSession session){
	...
	public String addXinwentongzhi(HttpServletRequest request, News news, HttpSession session){
		...
		/*if(u==null||u.equals("")){
		    ...
		    news.setAddtime(time.toString().substring(0, 19));
			xinwentongzhiService.add(news);
...
//	处理编辑
	...
	public String doUpdateXinwentongzhi(int id, ModelMap map, News news){
		news =xinwentongzhiService.getById(id);
		map.put("news", news);
	...
	public String XinwentongzhiDetail(int id, ModelMap map, News news){
		news =xinwentongzhiService.getById(id);
		map.put("news", news);
...
//	前台详细
	...
	public String xwtzDetail(int id, ModelMap map, News news){
		news =xinwentongzhiService.getById(id);
		map.put("news", news);
		return "gg_detail";
	}
...
//	
	...
	public String updateXinwentongzhi(int id, ModelMap map, News news){
		xinwentongzhiService.update(news);
...
//	分页查询
	...
	public String xinwentongzhiList(@RequestParam(value="page",required=false)String page,
									ModelMap map, HttpSession session, News news, String biaoti, String leibie, String neirong, String shouyetupian, String dianjilv, String tianjiaren, String lb){
		...
		List<News> list=xinwentongzhiService.getByPage(pmap);
