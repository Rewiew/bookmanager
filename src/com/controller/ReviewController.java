...
public class ReviewController {
	@Resource
	private ReviewServer pinglunService;
//	
   ...
   public String showPinglun(int id,ModelMap map,HttpSession session){
	...
	public String addPinglun(HttpServletRequest request, Review review, HttpSession session){
		Timestamp time=new Timestamp(System.currentTimeMillis());
		//Users u=(Users)session.getAttribute("user");
		/*if(u==null||u.equals("")){
			return "redirect:showIndex.do";
		}else{*/
		    review.setAddtime(time.toString().substring(0, 19));
			pinglunService.add(review);
...
//	处理编辑
	...
	public String doUpdatePinglun(int id, ModelMap map, Review review){
		review =pinglunService.getById(id);
		map.put("review", review);
		return "pinglun_updt";
	}
//	后台详细
	@RequestMapping("PinglunDetail.do")
	public String PinglunDetail(int id, ModelMap map, Review review){
		review =pinglunService.getById(id);
		map.put("review", review);
...
//	前台详细
	...
	public String plDetail(int id, ModelMap map, Review review){
		review =pinglunService.getById(id);
		map.put("review", review);
...
//	
	...
	public String updatePinglun(int id, ModelMap map, Review review){
		pinglunService.update(review);
		return "redirect:pinglunList.do";
	}
//	所有List
...
//	分页查询
	...
	public String pinglunList(@RequestParam(value="page",required=false)String page,
							  ModelMap map, HttpSession session, Review review, String xinwenID, String pinglunneirong, String pinglunren, String pingfen, String biao){
		...
		List<Review> list=pinglunService.getByPage(pmap);
