...
//	分页查询
	...
	public String shangpinxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Shangpinxinxi shangpinxinxi, String shangpinbianhao, String shangpinmingcheng, String leixing, String pinpai, String xiaoliang1,String xiaoliang2, String kucun1,String kucun2, String jiage1,String jiage2, String tupian, String shangpinjianjie){
