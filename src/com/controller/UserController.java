...
//	
   ...
   public String showAllusers(int id,ModelMap map,HttpSession session){
	...
	public String addAllusers(HttpServletRequest request, User user, HttpSession session){
		...
		/*if(u==null||u.equals("")){
			...
			bbs.setIsdel("1");*/
		    user.setAddtime(time.toString().substring(0, 19));
			allusersService.add(user);
...
//	处理编辑
	...
	public String doUpdateAllusers(int id, ModelMap map, User user){
		user =allusersService.getById(id);
...
//	
	...
	public String updateAllusers(int id, ModelMap map, User user){
...
//	分页查询
	...
	public String goodList(@RequestParam(value="page",required=false)String page,
						   ModelMap map, HttpSession session, User user, String username, String pwd, String cx){
		...
		List<User> list=allusersService.getByPage(pmap);
...
//   分页模糊查询
	...
	public void quchongAllusers(User user, HttpServletResponse response){
