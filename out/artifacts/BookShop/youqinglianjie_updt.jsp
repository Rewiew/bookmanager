	...
	<body>
			<form action="updateYouqinglianjie.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改友情连接<input type="hidden" name="id" value="${friendLink.id}" /></td>
						</tr>
		...
		<tr ><td width="200">LOGO：</td><td><input name='LOGO' type='text' id='LOGO' size='50' value='' onblur='' style='border:solid 1px #000000; color:#666666' />&nbsp;<input type='button' value='上传' onClick="up('LOGO')" style='border:solid 1px #000000; color:#666666'/></td></tr>
						...
						<script language="javascript">document.form1.wangzhanmingcheng.value='${friendLink.wangzhanmingcheng}';</script>
	<script language="javascript">document.form1.wangzhi.value='${friendLink.wangzhi}';</script>
	<script language="javascript">document.form1.LOGO.value='${friendLink.LOGO}';</script>
