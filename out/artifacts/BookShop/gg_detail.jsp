...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
 <%
  ...
  connDbBean.hsgexecute("update news set dianjilv=dianjilv+1 where id="+id);
%>
<body>
		...
		<div class="pad0">
			...
			<div class="det_con"> 
					<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FA8A89" class="newsline" style="border-collapse:collapse">
                          <tr>
                            <td height="46" align="center" class="STYLE1">${news.biaoti} (被访问${news.dianjilv }次) </td>
                          </tr>
                          <tr>
                            <td height="110" align="left">${news.neirong }</td>
                          </tr>
                          <tr>
