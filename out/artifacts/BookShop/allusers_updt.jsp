		...
		<tr >
		  ...
		  <td><select name="cx" id="cx">
            ...
            <option value="超级管理员">超级管理员</option>
						...
						<script language="javascript">document.form1.username.value='${user.username}';</script>
	<script language="javascript">document.form1.pwd.value='${user.pwd}';</script>
	<script language="javascript">document.form1.cx.value='${user.cx}';</script>
