  ...
  <div class="wrap">
		...
		<div class="pad20">
			<div class="title">
				...
				<div class="more"><a href="news.php?lb=站内新闻">更多 ></a></div>
			</div>
			<div class="f4_x"></div>
			<div class="wwdt">
				<div class="l_pic">
				...
				<div class="r_tw">
					...
					<a href="news.php?lb=站内新闻" class="more">更多动态</a>
				</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<div class="pad20">
			<div class="title">
				...
				<div class="more"><a href="dx_detail.php?lb=关于我们">更多 ></a></div>
			</div>
			<div class="f4_x"></div>
			<div class="wwdt">
				<div class="l_pic">
    ...
    ...　<a href="dx_detail.php?lb=关于我们">[详细]</a>
				</div>
				<div class="r_tw">
					<ul class="about_list">
						<li>
		...
		<div class="pad20">
			...
			<div class="links">
				 ...
				 <%
			String sqlyqlj="select  * from friendLink   order by id desc limit 0,5";
