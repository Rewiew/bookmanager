...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			...
			<dd><a href="shangpinxinxiList.do" target="rightFrame">商品信息查询</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">所有购买记录<img src="images/left/select_xl01.png"></dt>
			<dd><a href="goumaijiluList.do" target="rightFrame">所有购买记录</a></dd>
		</dl>
	
		<dl class="app">
			<dt onClick="changeImage()">所有订单<img src="images/left/select_xl01.png"></dt>
			<dd><a href="dingdanxinxiList.do" target="rightFrame">所有订单</a></dd>
		</dl>
