	...
	<body>
			<form action="updateXinwentongzhi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改新闻通知<input type="hidden" name="id" value="${news.id}" /></td>
						</tr>
		...
		<tr ><td width="200">添加人：</td><td><input name='tianjiaren' type='text' id='tianjiaren' onblur='' style='border:solid 1px #000000; color:#666666' value='${sessionScope.userxinxi.tianjiaren}' readonly="readonly" /></td></tr>
						...
						<script language="javascript">document.form1.biaoti.value='${news.biaoti}';</script>
	<script language="javascript">document.form1.leibie.value='${news.leibie}';</script>
	<script language="javascript">document.form1.neirong.value='${news.neirong}';</script>
	<script language="javascript">document.form1.shouyetupian.value='${news.shouyetupian}';</script>
	<script language="javascript">document.form1.dianjilv.value='${news.dianjilv}';</script>
	<script language="javascript">document.form1.tianjiaren.value='${news.tianjiaren}';</script>
