	...
	<body>
			<form action="updateGoumaijilu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改购买记录<input type="hidden" name="id" value="${PURCHASE.id}" /></td>
						</tr>
		...
		<tr 1><td width="200">备注：</td><td><input name='beizhu' type='text' id='beizhu' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
						...
						<script language="javascript">document.form1.shangpinbianhao.value='${PURCHASE.shangpinbianhao}';</script>
	<script language="javascript">document.form1.shangpinmingcheng.value='${PURCHASE.shangpinmingcheng}';</script>
	<script language="javascript">document.form1.leixing.value='${PURCHASE.leixing}';</script>
	<script language="javascript">document.form1.pinpai.value='${PURCHASE.pinpai}';</script>
	<script language="javascript">document.form1.xiaoliang.value='${PURCHASE.xiaoliang}';</script>
	<script language="javascript">document.form1.kucun.value='${PURCHASE.kucun}';</script>
	<script language="javascript">document.form1.jiage.value='${PURCHASE.jiage}';</script>
	<script language="javascript">document.form1.goumaishuliang.value='${PURCHASE.goumaishuliang}';</script>
	<script language="javascript">document.form1.goumaijine.value='${PURCHASE.goumaijine}';</script>
	<script language="javascript">document.form1.yonghuming.value='${PURCHASE.yonghuming}';</script>
	<script language="javascript">document.form1.beizhu.value='${PURCHASE.beizhu}';</script>
					 </table>
			</form>
   </body>
</html>
