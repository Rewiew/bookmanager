...
{
String sql="";
sql="select id from user where username='"+request.getSession().getAttribute("username")+"' and pwd='"+request.getParameter("ymm")+"'";
 ResultSet RS_result=connDbBean.executeQuery(sql);
 if(RS_result.next())
 {
 	sql="update user set pwd='"+request.getParameter("xmm1")+"' where username='"+request.getSession().getAttribute("username")+"' ";
...
%>
  <body >
    ...
    <tr>
      <td colspan="2" align="center"><input name="updt" type="hidden" id="updt" value="1">
