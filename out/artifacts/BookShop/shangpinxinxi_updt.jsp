	...
	<body>
			<form action="updateShangpinxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改商品信息<input type="hidden" name="id" value="${shopItem.id}" /></td>
						</tr>
		...
		<tr ><td width="200">类型：</td><td><select name='leixing' id='leixing'>
		...
		<tr ><td width="200">商品简介：</td><td><textarea name='shangpinjianjie' cols='50' rows='5' id='shangpinjianjie' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
						...
						<script language="javascript">document.form1.shangpinbianhao.value='${shopItem.shangpinbianhao}';</script>
	<script language="javascript">document.form1.shangpinmingcheng.value='${shopItem.shangpinmingcheng}';</script>
	<script language="javascript">document.form1.leixing.value='${shopItem.leixing}';</script>
	<script language="javascript">document.form1.pinpai.value='${shopItem.pinpai}';</script>
	<script language="javascript">document.form1.xiaoliang.value='${shopItem.xiaoliang}';</script>
	<script language="javascript">document.form1.kucun.value='${shopItem.kucun}';</script>
	<script language="javascript">document.form1.jiage.value='${shopItem.jiage}';</script>
	<script language="javascript">document.form1.tupian.value='${shopItem.tupian}';</script>
	<script language="javascript">document.form1.shangpinjianjie.value='${shopItem.shangpinjianjie}';</script>
					 </table>
			</form>
   </body>
</html>
