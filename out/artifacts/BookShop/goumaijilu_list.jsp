...
-->
    ...
    <td>${u.yonghuming}</td>
    <td>${u.beizhu}</td>
    <td align='center'>${u.issh} <c:if test="${u.issh=='否'}"><input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=PURCHASE'"/></c:if></td>
