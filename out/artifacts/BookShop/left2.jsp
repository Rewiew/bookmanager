...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			<dt onClick="changeImage()">用户资料管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="doUpdateYonghuzhuce2.do" target="rightFrame">用户资料管理</a></dd>
		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">我的购物车<img src="images/left/select_xl01.png"></dt>
			<dd><a href="goumaijiluList2.do" target="rightFrame">我的购物车</a></dd>

		</dl>
	
		<dl class="channel">
			<dt onClick="changeImage()">我的订单<img src="images/left/select_xl01.png"></dt>
			<dd><a href="dingdanxinxiList2.do" target="rightFrame">我的订单</a></dd>
		</dl>
