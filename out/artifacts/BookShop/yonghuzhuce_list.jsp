...
-->
    ...
    <td align='center'>${u.issh} <c:if test="${u.issh=='否'}"><input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=loginUser'"/></c:if></td>
