...
-->
	...
	<body>
			<form action="updateYonghuzhuce2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改用户注册<input type="hidden" name="id" value="${loginUser.id}" /></td>
						</tr>
		...
		<tr 2><td width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
						...
						<script language="javascript">document.form1.yonghuming.value='${loginUser.yonghuming}';</script>
	<script language="javascript">document.form1.mima.value='${loginUser.mima}';</script>
	<script language="javascript">document.form1.xingming.value='${loginUser.xingming}';</script>
	<script language="javascript">document.form1.xingbie.value='${loginUser.xingbie}';</script>
	<script language="javascript">document.form1.chushengnianyue.value='${loginUser.chushengnianyue}';</script>
	<script language="javascript">document.form1.QQ.value='${loginUser.QQ}';</script>
	<script language="javascript">document.form1.youxiang.value='${loginUser.youxiang}';</script>
	<script language="javascript">document.form1.shouji.value='${loginUser.shouji}';</script>
	<script language="javascript">document.form1.shenfenzheng.value='${loginUser.shenfenzheng}';</script>
	<script language="javascript">document.form1.touxiang.value='${loginUser.touxiang}';</script>
	<script language="javascript">document.form1.dizhi.value='${loginUser.dizhi}';</script>
	<script language="javascript">document.form1.beizhu.value='${loginUser.beizhu}';</script>
