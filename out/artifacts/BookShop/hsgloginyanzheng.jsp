...
<html>
 ...
 String sql="";
 if(cx.equals("管理员")){sql="select * from user where username='"+uid+"' and pwd='"+pwd+"'";}
 if(cx.equals("注册用户")){sql="select * from loginUser where yonghuming='"+uid+"' and mima='"+pwd+"' and issh='是'";}
 //quxanxiaxndexnglxu
