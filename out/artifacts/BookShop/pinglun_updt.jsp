	...
	<body>
			<form action="updatePinglun.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改评论<input type="hidden" name="id" value="${review.id}" /></td>
						</tr>
		...
		<tr ><td width="200">表：</td><td><input name='biao' type='text' id='biao' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
						...
						<script language="javascript">document.form1.xinwenID.value='${review.xinwenID}';</script>
	<script language="javascript">document.form1.pinglunneirong.value='${review.pinglunneirong}';</script>
	<script language="javascript">document.form1.pinglunren.value='${review.pinglunren}';</script>
	<script language="javascript">document.form1.pingfen.value='${review.pingfen}';</script>
	<script language="javascript">document.form1.biao.value='${review.biao}';</script>
